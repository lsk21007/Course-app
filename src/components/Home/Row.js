    ...
    <>
      <div className="row__buttons">
        <button
          ...
          className={`row__btn ${categoryData && categoryData[0]?.category === 'python' ? 'selected' : ''}`}
        >
          Python
        </button>
        <button
          ...
          className={`row__btn ${categoryData && categoryData[0]?.category === 'Excel' ? 'selected' : ''}`}
        >
          Excel
        </button>
        <button
          ...
          className={`row__btn ${categoryData && categoryData[0]?.category === 'web-development' ? 'selected' : ''}`}
        >
          Web Development
        </button>
        <button
          ...
          className={`row__btn ${categoryData && categoryData[0]?.category === 'javascript' ? 'selected' : ''}`}
        >
          JavaScript
        </button>
      </div>
